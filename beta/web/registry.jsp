         ...
         <div class="row">
            ...
            <div class="col-md-4 center-block">
                <form action="RegisterController" method="post">
                    ...
                    <br>
                    <input type="email" name="Correo" class="form-control" placeholder="Correo" required autofocus value="<jsp:getProperty name="user" property="correo"/>">
                    <br>
                    <input type="tel" name="Telefono" class="form-control" placeholder="Telefono" required autofocus value="<jsp:getProperty name="user" property="telefono"/>">
                    <br>
                    <input type="password" name="Password" class="form-control" placeholder="Contraseña" required autofocus value="<jsp:getProperty name="user" property="password"/>">
                    <br>
                    <div class="row">
                        <div class="col-md-6">
